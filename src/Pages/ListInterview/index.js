...
const MeetingMap = ({meetingData}) =>{
    ...
    const[searchField,handleSearchField] = useState("");
    ...
    useEffect(()=>{
        handleMeetingData(meetingData.filter((md) => md.title.toLowerCase().includes(searchField.toLowerCase())))
    },[searchField])
    ...
    return(
        <div>
            <div className="d-flex align-items-center search-div">
                <svg width="15px" height="15px" viewBox="0 0 16 16" className="bi bi-search" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    <path fillRule="evenodd" d="M10.442 10.442a1 1 0 0 1 1.415 0l3.85 3.85a1 1 0 0 1-1.414 1.415l-3.85-3.85a1 1 0 0 1 0-1.415z"/>
                    <path fillRule="evenodd" d="M6.5 12a5.5 5.5 0 1 0 0-11 5.5 5.5 0 0 0 0 11zM13 6.5a6.5 6.5 0 1 1-13 0 6.5 6.5 0 0 1 13 0z"/>
                </svg>
                <input type ='text' placeholder="Search by title..." value={searchField} className="search-input" onChange={(e)=>handleSearchField(e.target.value)}/> 
            </div>
            {meeting_data.length === 0?<div className="mt-4">There are no Meetings Scheduled</div>:(
            ...
            <div>
                {meetingData === null?(
                    ...
                    <div className="container-div1 d-flex flex-column mb-5" style={{border:'0px'}}>
                        ...
                        <div className="d-flex flex-row flex-wrap mt-4">
                            <MeetingMap meetingData={meetingData}/>
                        </div>
                    </div>
                )}
            </div>
